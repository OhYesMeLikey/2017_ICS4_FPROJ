...
class ClubClass extends SuitClass                                                               // ClubClass inherits SuitClass
{
	...
	g.setColor (getColour ());                                                              // Set the colour of the club.
	...
	{
	    g.drawOval (iPointsX [3], iPointsY [3], getWidth () / 2, getHeight () / 2);
	    g.drawOval (iPointsX [4], iPointsY [4], getWidth () / 2, getHeight () / 2);
	    g.drawOval (getCentreX () - getWidth () / 4, getCentreY () - 4 * (getHeight () / 7), getWidth () / 2, getHeight () / 2);
