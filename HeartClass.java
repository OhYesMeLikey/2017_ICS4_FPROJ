...
public class HeartClass extends SuitClass                                                       // This is a Heart class inherits SuitClass.
{
	...
	g.setColor (getColour ());                                                              // Set the colour of the heart.
	...
	{
	    g.drawArc (iPointsX [3], iPointsY [3], getWidth () / 2, getHeight () / 2, 0, 180);
	    g.drawArc (iPointsX [4], iPointsY [4], getWidth () / 2, getHeight () / 2, 0, 180);
